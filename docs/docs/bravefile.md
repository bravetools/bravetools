...
1. ``public`` - specifies that images are to be pulled from the [ubuntu cloud](https://cloud-images.ubuntu.com/releases) repository. Accepted image name syntax is ``Distribution/Release/Architecture``.
